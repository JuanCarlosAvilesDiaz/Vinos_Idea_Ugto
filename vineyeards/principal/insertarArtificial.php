...
<head>
    ...
    <?php require '../partials/validacion_nav.php'; ?>
        ...
        <div class="row my-5">
            ...
            <form action="../consultas/artificial.php" method="POST" class="medircolor">            
                <h3 class="display-5 text-primary text-center">MEDICIÓN MUESTRA ARTIFICIAL</h3>
                ...
                <div class="form-group">
                    ...
                    <select name="id_muestra" class="form-control">
                        <?php 
                            ...
                            $consultar="SELECT * FROM muestra_artif";
                            $ejecutar=mysqli_query($conexion,$consultar) or die(mysqli_error($conexion));
                        ?>

                        <?php foreach ($ejecutar as $opciones): ?>

                            <option value="<?php echo $opciones['id_muestra']?>"><?php echo $opciones['codificacion_id']?></option>
               ...
               <br>                
                <div>
                    ...
                    <a href="registrosArtificiales.php" class="btn btn-danger">VerLista</a>
                    </center>
                </div>                                           
            </form>
            </div>  
