...
<head>
    ...
    <?php require '../partials/validacion_nav.php'; ?>
        <section class="container">
            ...
            <form action="../consultas/vino.php" method="POST" class="medircolor">            
                <h3 class="display-5 text-primary text-center">MEDICIÓN MUESTRA VINO</h3>
                <div class="form-group">
                    <label >Tipo de Muestra:</label>
                    <select name="tipo_de_muestra" class="form-control" disabled>
                        <option value="Artificial" >Artificial</option>
                        <option value="Vino" selected>Vino</option>
                ...
                <div class="form-group">
                    ...
                    <select name="id_muestra" class="form-control">
                        <?php 
                            ...
                            $consultar="SELECT * FROM muestra_vino";
                            $ejecutar=mysqli_query($conexion,$consultar) or die(mysqli_error($conexion));
                        ?>

                        <?php foreach ($ejecutar as $opciones): ?>

                            <option value="<?php echo $opciones['id_muestra_vino']?>"><?php echo $opciones['codificacion_id']?></option>
               ...
               <br>                
                <div>
                    ...
                    <a href="registrosVino.php" class="btn btn-danger">VerLista</a>
                    </center>
                </div>
