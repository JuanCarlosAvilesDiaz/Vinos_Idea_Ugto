...
<head>
    ...
    <title>Tabla de mediciones Mosto</title>
</head>
<body>
<?php require '../partials/validacion_nav.php'; ?>
    
    <h1><center>Mediciones Mosto</center></h1>
    <table class="table table-dark table-sm">
      ...
      <tbody>
        ...
        <?php 
                            ...
                            $consultar="SELECT id_medir, arreglo_exp.descripcion as descripcion_exp, tipo_de_muestra, muestra_mosto.codificacion_id as codificacion_id, palabra_clave.descripcion as descripcion_palabra, equipo.descripcion as descripcion_equi, vol_gota, 
                            ...
                            INNER JOIN muestra_mosto ON medir.id_muestra_mosto=muestra_mosto.id_muestra_mosto 
