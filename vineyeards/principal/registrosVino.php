...
<head>
    ...
    <title>Tabla de mediciones Vino</title>
</head>
<body>
<?php require '../partials/validacion_nav.php'; ?>
    <h1><center>Mediciones Vino</center></h1>
    <table class="table table-dark table-sm">
      ...
      <tbody>
        ...
        <?php 
                            ...
                            $consultar="SELECT id_medir, arreglo_exp.descripcion as descripcion_exp, tipo_de_muestra, muestra_vino.codificacion_id as codificacion_id, palabra_clave.descripcion as descripcion_palabra, equipo.descripcion as descripcion_equi, vol_gota, 
                            ...
                            INNER JOIN muestra_vino ON medir.id_muestra_vino=muestra_vino.id_muestra_vino 
